...
public:
    ...
    QString createQStringForGrants(int startYear, int endYear, std::vector<std::string> sortFields, char filterStart, char filterEnd);
    QList<QVariant> createHeadersListForGrants(std::string topLevel);
    QString createQStringForPres(int startYear, int endYear, std::vector<std::string> sortFields, char filterStart, char filterEnd);
    QList<QVariant> createHeadersListForPres(std::string topLevel);
    QString createQStringForPubs(int startYear, int endYear, std::vector<std::string> sortFields, char filterStart, char filterEnd);
    QList<QVariant> createHeadersListForPubs(std::string topLevel);
    QString createQStringForTeaching(int startYear, int endYear, std::vector<std::string> sortFields, char filterStart, char filterEnd);
    ...
    std::vector<std::pair<std::string, int>> getCountTuple(int startYear, int endYear,
            std::vector<std::string> headers, std::vector<std::string> matchString, char filterStart, char filterEnd);
    std::vector<std::pair<std::string, double>> getTotalsTuple(int startYear, int endYear,
            std::vector<std::string> headers, std::vector<std::string> matchStrings, std::string accCol, char filterStart, char filterEnd);
